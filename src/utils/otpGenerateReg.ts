...
export const generateOtpReg = async (payload: { email: string }) => {
  ...
  const textForRegistration = `Thank you for registering with ProBanesa. To complete your registration, please verify your email address by entering the verification code below.`;
